...
(function() {
    ...
    //     context._clearRect(0, 0, width, height);
    //     fillStyle = 'white';
    //     console.error('clearRect - fillStyle - ', fillStyle);
    //     context.fillRect(0, 0, width, height); // fill white background
    // }
    ...
    var drawHelper = {
        ...
        refreshColorValues() {
            var strokeStyleText = find('stroke-style'),
        ...
        text: function(context, point, options) {
            var strokeStyleText = find('stroke-style');
            fillStyle = strokeStyleText.value;
            this.handleOptions(context, options);
    ...
    var textHandler = {
        ...
        getFillColor: function(color) {
            var strokeStyleText = find('stroke-style');
            return strokeStyleText.value;
            // return '#' + document.getElementById('pencil-fill-style').value;
    ...
    (function() {
        ...
        function decorateDragLastPath() {
            ...
            var image = new Image();
            image.onload = function() {
                context.drawImage(image, 6, 6, 28, 28);
        ...
        function decorateEraser() {
            ...
            addEvent(context.canvas, 'dblclick', function() {
                hideContainers();
